...
repository:~\cite{OLED_repo} from Michael Mattioli, which provides a simple and
effective way to interface with the display, implemented in VHDL and designed for the ZedBoard.
\paragraph{}
...
represent any note detected by our system, since the guitar's string can produce frequencies
at most around 400Hz.
\paragraph{}
...
This counter is also passed to the OLED module as a BCD encoded 'std_logic_vector'.